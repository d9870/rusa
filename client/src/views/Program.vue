<template>
    <div class="Program">
        ...
        <!-- program -->
        <section class="hero is-halfwidth is-link">
            <div class="hero-body">
                <div class="container">
                    <p class="title is-1">
                        HTML
                        ...
                        <div class="is-block">
                            <div class="columns">
                                <div class="column has-text-left">
                                    <router-link class="button is-link" :to="{name:'home'}">Back</router-link>
                                </div>
                                <div class="column has-text-right">
                                    <router-link class="button is-success" :to="{name:'register'}">Register</router-link>
